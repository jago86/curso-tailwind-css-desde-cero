Vue.component('link-cascadia', {
    template: `
        <a class="group flex items-center text-do-blue-light hover:text-do-blue-medium font-cascadia text-lg font-bold" href="">
            <slot></slot>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-all group-hover:ml-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
Vue.component('panel-blog', {
    template: `
        <div class="flex flex-col bg-white transition-shadow shadow-lg hover:shadow-2xl rounded-lg">
            <div>
